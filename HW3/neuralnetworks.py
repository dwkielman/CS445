...
class NeuralNetwork_relu(NeuralNetwork):
    ...
    # based on code from comments here: https://stackoverflow.com/questions/32109319/how-to-implement-the-relu-function-in-numpy/46837904
    def activation(self, weighted_sum):
        return np.maximum(weighted_sum,0)

    # based on code from comments here: https://codereview.stackexchange.com/questions/132023/different-neural-network-activation-functions-and-gradient-descent
    def activation_derivative(self, activation_value):
